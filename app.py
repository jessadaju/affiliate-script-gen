...
# --- 2. ระบบอีเมล (Email Service - Fixed UTF-8) ---
def send_verification_email(to_email, otp_code):
    """ส่งอีเมล OTP หาผู้สมัคร (รองรับภาษาไทยสมบูรณ์)"""
    try:
        ...
        # ✅ แก้ไขจุดที่ 1: ระบุ charset='utf-8' ที่เนื้อหาจดหมาย
        msg = MIMEText(body, 'plain', 'utf-8')
        
        # ✅ แก้ไขจุดที่ 2: ใช้ Header() หุ้มหัวข้อจดหมาย
...
def check_user_exists(username):
    """เช็กว่ามี user นี้หรือยัง (ยังไม่บันทึก)"""
    sheet = connect_to_gsheet()
    if not sheet: return True # กันเหนียว
    try:
