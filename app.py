...
# 🎨 CSS เสริม: บังคับให้ Canvas มี Scrollbar หากภาพใหญ่กว่าจอ (สำหรับโหมด 1:1)
st.markdown("""
    <style>
        /* บังคับให้ Canvas container มี scrollbar */
...
def process_video_with_mask(video_path, mask_image_data, quality_mode="High"):
    ...
    try:
        ...
        # Resize Mask ให้เท่ากับขนาดวิดีโอ (สำคัญมาก: เพื่อให้แน่ใจว่า pixel ตรงกัน ไม่ว่าจะวาดโหมดไหน)
